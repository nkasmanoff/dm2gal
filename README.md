...
This repository contains the work used to create the paper accepted to the NeurIPS 2020 Machine Learning and the Physical Sciences workshop, "dm2gal: Mapping Dark Matter to Galaxies with Neural Networks"
