...
# read header
FILE_TYPE = 'hydrosim/' #or subhalos
root = '/projects/QUIJOTE/Noah/dm2gal/dat/illustris-data/' + FILE_TYPE + 'groupcat/groups_099/'
basePath = '/projects/QUIJOTE/Noah/dm2gal/dat/illustris-data/' + FILE_TYPE + 'groupcat'
